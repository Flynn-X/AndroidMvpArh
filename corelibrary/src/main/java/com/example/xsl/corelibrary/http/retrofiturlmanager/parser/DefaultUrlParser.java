 ...
 */
package com.example.xsl.corelibrary.http.retrofiturlmanager.parser;
...
import static  com.example.xsl.corelibrary.http.retrofiturlmanager.RetrofitUrlManager.IDENTIFICATION_PATH_SIZE;

/**
 * ================================================
 * 默认解析器, 可根据自定义策略选择不同的解析器
 * <p>
 * 如果您觉得 {@link DefaultUrlParser} 的解析策略并不能满足您的需求, 您可以自行实现更适合您的 {@link me.jessyan.retrofiturlmanager.parser.UrlParser}
 * 然后通过 {@link RetrofitUrlManager#setUrlParser(me.jessyan.retrofiturlmanager.parser.UrlParser)} 配置给框架, 即可替换 {@link DefaultUrlParser}
