 ...
 * @date 2019-09-26
 */
public class CenterSpinner extends AppCompatTextView {
    ...
    private OnCelerySpinnerItemSelectedListener onCelerySpinnerItemSelectedListener;
    ...
    private OnSpinnerOnClickListener onSpinnerOnClickListener;

    @Nullable
    private ObjectAnimator arrowAnimator = null;

    public CenterSpinner(Context context) {
        super(context);
        init(context, null);
    }

    public CenterSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public CenterSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setClickable(true);
        backgroundSelector = typedArray.getResourceId(R.styleable.NiceSpinner_backgroundSelector, R.drawable.core_selector);
        ...
        popupWindow.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (onCelerySpinnerItemSelectedListener != null) {
                    onCelerySpinnerItemSelectedListener.onItemSelected(CenterSpinner.this, view, position, id);
                }
        ...
        arrowDrawableResId = typedArray.getResourceId(R.styleable.NiceSpinner_arrowDrawable, R.drawable.core_arrow);
    ...
    public void setArrowDrawable(@DrawableRes @ColorRes int drawableId) {
        ...
        arrowDrawable = initArrowDrawable(R.drawable.core_arrow);
        setArrowDrawableOrHide(arrowDrawable);
    ...
    public OnCelerySpinnerItemSelectedListener getOnCelerySpinnerItemSelectedListener() {
        return onCelerySpinnerItemSelectedListener;
    }

    public void setOnSpinnerItemSelectedListener(OnCelerySpinnerItemSelectedListener onCelerySpinnerItemSelectedListener) {
        this.onCelerySpinnerItemSelectedListener = onCelerySpinnerItemSelectedListener;
    }

    public interface OnSpinnerOnClickListener{
        void arrowUp();
        void arrowDown();
    }

    public void setOnSpinnerOnClickListener(OnSpinnerOnClickListener onSpinnerOnClickListener) {
        this.onSpinnerOnClickListener = onSpinnerOnClickListener;
    }
